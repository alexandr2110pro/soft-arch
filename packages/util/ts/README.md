...
```typescript
import type { Simplify } from '@space-architects/util-ts';
...
```typescript
import type { SimplifyDeep } from '@space-architects/util-ts';
...
```typescript
import type { PropTupleFromArray } from '@space-architects/util-ts';
